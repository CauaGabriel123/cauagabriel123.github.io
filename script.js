// =========================
// LS STORE v11.2.1 — Cauã (correção splash + modal)
// =========================
...
// =============================
// ALERTA / CARRINHO / ENTREGA / PDF / TOPO
// =============================
...
paymentSel.onchange=()=>{cashSection.style.display=(paymentSel.value==='Dinheiro')?'block':'none';};
cashRadios.forEach(r=>r.onchange=()=>{cashAmount.style.display=(r.value==='sim')?'inline-block':'none';});
deliveryType.onchange=()=>{addressFields.style.display=(deliveryType.value==='entrega')?'block':'none';};
...
loginBtn.onclick=()=>{
  accountArea.innerHTML=`<div class="auth-card">
    ...
    <label>Senha<input type="password" id="login-pass"></label>
