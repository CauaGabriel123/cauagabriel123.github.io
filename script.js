...
/* ===============================
   FIX FINAL — Ordem completa (com quantidade)
   =============================== */
...
.lsx-price        { order: 1 !important; }
#lsxColors        { order: 2 !important; }
#lsxSizes         { order: 3 !important; }
.lsx-stock        { order: 4 !important; }
.lsx-qty          { order: 5 !important; }  /* ⬅ quantidade abaixo do estoque */
.lsx-cta          { order: 6 !important; }
.lsx-details      { order: 7 !important; }

/* Rótulos de cor/tamanho */
#lsxColors::before {
  content: "Cor disponível:" !important;
  display: block !important;
  font-weight: 600 !important;
  color: #7A3BFD !important;
  margin-bottom: 4px !important;
  font-size: 0.9rem !important;
}
#lsxSizes::before {
  content: "Tamanho disponível:" !important;
  display: block !important;
  font-weight: 600 !important;
  color: #7A3BFD !important;
  margin-bottom: 4px !important;
...
/* Espaçamento */
#lsxColors, #lsxSizes, .lsx-stock, .lsx-qty {
  width: 100% !important;
